...
<template>
  <div class="page">
    <PageHeader
      title="Laporan Transaksi Kartu"
      subtitle="Rekap & detail transaksi akses kartu"
    />
    ...
    <template v-else-if="recap">
      ...
      <div class="tabs">
        ...
        <Button v-if="activeTab !== 'detail'" variant="ghost" size="sm" @click="download(activeTab, { preview: true })">👁 Pratinjau PDF</Button>
      </div>
...
<style scoped src="./Reports_css/ReportKartu.css"></style>
